...
function Contact() {
  ...
  return (
    ...
    >
      <div className="max-w-4xl w-full space-y-8 bg-blue-100 bg-opacity-95 p-10 rounded-lg shadow-lg">
          ...
          <div className="w-full md:w-1/2 md:pl-4">
            ...
            <ul className="space-y-4">
              <li className="flex items-center space-x-2">
                ...
                <span>+91 7483040105</span>
              </li>
              <li className="flex items-center space-x-2">
                <FaEnvelope className="text-pink-500" />
                <span>ananya9380@gmail.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <FaMapMarkerAlt className="text-green-500" />
                <span>NIE, Mysuru, Karnataka, India</span>
              </li>
            </ul>
          </div>
        </div>
